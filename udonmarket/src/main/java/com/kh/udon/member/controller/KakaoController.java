...
public class KakaoController {
	...
	private final static String K_CLIENT_ID = "91a359c6f4f2628b3f78a34ef78b9d82";
    private final static String K_REDIRECT_URI = "http://localhost:9090/udon/member/memberLogin";
